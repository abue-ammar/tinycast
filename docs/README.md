...
| [standards.md](standards.md) | How code here is written: platform posture, naming, style, concurrency, performance budgets, comments | a convention changes, or a check is added |
...
| [development.md](development.md) | The local loop: supported macOS, setup, build, dev channel, editor, format/lint, generated data | the local toolchain changes |
...
| [ui.md](ui.md) | The design system: tokens, panel chrome, row grammar, floating surfaces, dialogs and HUDs | a token or a presentation rule changes |
