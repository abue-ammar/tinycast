...
| `pasteboard-test` | `Clipboard/Service/ClipboardManager.swift` capture and `Paster.write` — Finder file ordering, file paste, and a delayed owner without main-run-loop stall |
