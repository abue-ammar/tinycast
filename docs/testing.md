...
`.github/workflows/ci.yml` runs the harnesses and lint on every PR. The build, the purity grep and
the manual sweep are on you, run locally. CodeRabbit reviews each PR, but it is a reviewer,
