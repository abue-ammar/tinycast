...
shipping binary — the app and both bundled clipboard helpers: trusting `ARCHS_STANDARD` is what
...
of the same bug: the app boots on Intel while clipboard capture or OCR stops working.
