...
// Unicode emoji ≤ E15.1 + curated symbols; fields: glyph|name|category|tone|keywords.
enum EmojiData {
    static let raw = """
...
👯|people with bunny ears|sp|0|bestie bff counterpart dancer double ear identical pair
...
🤼|people wrestling|sp|0|combat duel grapple ring tournament wrestle
